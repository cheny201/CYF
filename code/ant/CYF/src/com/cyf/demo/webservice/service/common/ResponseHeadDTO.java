 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;name xmlns="http://service.ccic.com/common/bean" xmlns:xs="http://www.w3.org/2001/XMLSchema"&gt;��Ӧ��Ϣͷ&lt;/name&gt;
 * </pre>
 * 
 * 
...
public class ResponseHeadDTO {
	...
	public String toString() {
		return "ResponseHeadDTO [seqNo=" + seqNo + ", consumerSeqNo="
				+ consumerSeqNo + ", providerSeqNo=" + providerSeqNo
				+ ", status=" + status + ", esbCode=" + esbCode
				+ ", esbMessage=" + esbMessage + ", appCode=" + appCode
